    ...
    function MyChart() {
        ...
        <ResponsiveContainer width="100%" height="100%">
            ...
            <Line type="monotone" dataKey="humid" stroke="#8884d8" activeDot={{ r: 8 }} />
                            <Line type="monotone" dataKey="temp" stroke="#95D2B3" />
                            <Line type="monotone" dataKey="uv" stroke="#FF6969" />
            </LineChart>
      </ResponsiveContainer>
            </div>
    );
            ...
            return (
                <div className="detail-hour-block" style={{ display: changeDisplay }}>
                    <div style={{
                        ...
                        <div className="close-button" onClick={handleChangeDisplayNone}>Close</div>
            ...
            forecastday.map((item, index) => {
                ...
                return (
                    <div style={{ marginBottom: "0", marginTop: "0" }} key={index} className="forecastDay" onClick={() => { handleChangeForecastHour(index); }}>
                        {index==0?<h3 >Today</h3>:<h4>{item.date}</h4>}
